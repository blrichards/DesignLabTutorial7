 ...
 * the array.
 *
 * @param <E> the type of the objects stored in the array (must implement
 *            Comparable)
 */
public class HeapArray<E extends Comparable<E>> implements Iterable<E> {
     ...
     *
     * @param <T>              the array element type used for the return array.
     * @param destinationArray the array used as specified above.
     ...
     *
     * @param childIndex the index used for the original placement of target.
     * @param target     the item to be placed and sifted.
     */
